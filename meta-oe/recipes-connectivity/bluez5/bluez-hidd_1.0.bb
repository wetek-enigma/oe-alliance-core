...
CFLAGS_append_wetekplay2 = " -Wall -I${S} -I${S}/lib -I${includedir}/glib-2.0 -I${STAGING_DIR}/${MACHINE}/usr/lib/glib-2.0/include -I${STAGING_DIR}/${MACHINE}/usr/include/glib-2.0"
